...
<body>
    <div class="container">
        ...
        <ul>
            ...
            <li>API Tomás: <a href="https://sos2324-10.appspot.com/api/v1/vehicles-stock"> API-TLR</a> (developed by Tomás Lozano)</li>
        ...
        <ul>
            ...
            <li>TOMÁS: <a href="http://sos2324-10.appspot.com/api/v1/vehicles-stock/docs"> API_TLR </a>(developed by Tomás Lozano Romero)</li>
        ...
        <ul>
            ...
            <li>TOMÁS:  <a href="http://sos2324-10.appspot.com/vehicles-stock"> vehicles-stock </a> (developed by Tomás Lozano Romero)</li>
            <li>ÁLVARO:  <a href="http://sos2324-10.appspot.com/tourisms-per-age"> tourisms-per-age </a> (developed by Álvaro Suárez Carbonell)</li>
